export const CONFIG = {
  ...
  audio: {
    movementTrackSrcs: Array.from({ length: 12 }, (_, i) => `/loops/tt${i + 1}.mp3`),
    movementThreshold: 0.0,
    minVolume: 0.0,
    maxVolume: 0.2,
    movementReleaseFadeSeconds: 0.5,
    brakeTrackSrcs: Array.from({ length: 4 }, (_, i) => `/loops/tb${i + 1}.mp3`),
    ...
    musicTrackSrcs: ["/track1.mp3", "/track2.mp3", "/track3.mp3", "/track4.mp3"],
    musicVolume: 0.5,
    musicFadeInMs: 4_000,
